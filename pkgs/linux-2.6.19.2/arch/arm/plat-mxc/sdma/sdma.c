...
#ifdef DO_ULOG
	ulog(ULOG_KERNEL_DMA_CHANNEL_CLBK,channel);
#endif
...
#ifdef DO_ULOG
	ulog(ULOG_KERNEL_DMA_CHANNEL,channel);
	ulog(ULOG_KERNEL_DMA_SRC_ADDR,(unsigned int)p->sourceAddr);
	ulog(ULOG_KERNEL_DMA_DST_ADDR,(unsigned int)p->destAddr);
	ulog(ULOG_KERNEL_DMA_COUNT,p->count);
#endif
