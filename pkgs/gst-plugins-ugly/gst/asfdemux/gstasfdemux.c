 ...
 *
 * Modified by Sagemcom under LGPL license on 25/10/2007 
...
GST_STATIC_PAD_TEMPLATE ("sink",
    ...
    GST_STATIC_CAPS ("video/x-ms-asf; "
		     "video/x-ms-wmv; "
		     "audio/x-ms-wma") /* SAGEM: Add more MIME Types */
    );
    ...
    guint64 size)
{
  ...
  if (stream) {
    ...
    /*SAGEM: avoid segmentation fault in debug mode */
...
error_encrypted:
  {
    GST_ELEMENT_ERROR (demux, STREAM, FAILED, (NULL), (NULL));
    return GST_FLOW_ERROR;
  }
}
