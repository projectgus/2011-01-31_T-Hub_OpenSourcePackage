...
all_services="hostname devfsd filesystems syslog depmod modules network settime inetd portmap dropbear boa smb dhcpd qtopia"
all_services_r="qtopia dhcpd smb boa dropbear portmap inetd settime network modules depmod syslog filesystems devfsd hostname"

cfg_services="hostname $devfsd filesystems $syslog depmod modules $network $settime $inetd $portmap $dropbear $boa $smb $dhcpd $qtopia"

cfg_services_r="$qtopia $dhcpd $smb $boa $dropbear $portmap $inetd $settime $network modules depmod $syslog filesystems $devfsd hostname"
