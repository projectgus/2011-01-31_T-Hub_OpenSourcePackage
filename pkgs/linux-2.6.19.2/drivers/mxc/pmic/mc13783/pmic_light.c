...
{
	CHECK_ERROR(pmic_write_reg(LREG_0, 7, PMIC_ALL_BITS));
	CHECK_ERROR(pmic_write_reg(LREG_1, 0, PMIC_ALL_BITS));
	CHECK_ERROR(pmic_write_reg(LREG_2, 0x1E010, PMIC_ALL_BITS));
	CHECK_ERROR(pmic_write_reg(LREG_3, 0, PMIC_ALL_BITS));
#ifdef CONFIG_MACH_MX27MEDIAPHONE
	CHECK_ERROR(pmic_write_reg(LREG_4, 0x7C1, PMIC_ALL_BITS));
#else
	CHECK_ERROR(pmic_write_reg(LREG_4, 0x7C3, PMIC_ALL_BITS));
