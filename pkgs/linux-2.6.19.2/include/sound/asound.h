...
//SAGEM added new struct IOCTL definition
struct snd_ctl_factory_prm
{
   unsigned int pmic_output_volume_max_cap;
   unsigned int pmic_input_volume_max_cap;
   unsigned int pmic_output_volume_max;
   unsigned int pmic_input_volume_max;
   unsigned int pmic_output_volume_default;
   unsigned int pmic_input_volume_default;
   
   /* for forward compatibility */
   unsigned int pmic_headset_volume_max_cap;
   unsigned int pmic_headset_volume_max;
   unsigned int pmic_headset_volume_default;
};
//end SAGEM
...
//SAGEM added new struct IOCTL definition
	SNDRV_CTL_IOCTL_GET_FACTORY_PARAMS = _IOWR('U', 0xd2,struct snd_ctl_factory_prm),
	SNDRV_CTL_IOCTL_SET_FACTORY_PARAMS = _IOR('U', 0xd3,struct snd_ctl_factory_prm),
//end SAGEM
};
