 ...
 *         	A0000000	128M	CS0 NOR Flash (not mapped)
 * F0000000 A8000000	64M	CS1 Ethernet
 *         	B0000000	32M	CS2
 *         	B2000000	32M	CS3
...
#define     CS1_BASE_ADDR_VIRT      0xF0000000
#define     CS1_SIZE                SZ_64M
...
#define IO_ADDRESS(x)   \
        ...
        (0xDEADBEEF/*  + printk(__FILE__ ": %d x = %x", __LINE__,  x) */))
...
#define IS_STATIC_MAPPED(x)						\
	 ...
	 (((x) >= L2CC_BASE_ADDR_VIRT) && ((x) < (L2CC_BASE_ADDR_VIRT + L2CC_SIZE))) || \
