/*
    ...
    Modified by Sagemcom under GPL license on 10/08/2008 
			      ...
			      unsigned int init_media)
{
...
#if defined(CONFIG_EVTPROBE2)
		send_netlink_msg(SYSM_E1, 0, GFP_ATOMIC); /* E1 = 0, Ethernet link is DOWN event. */
#endif
		return 0; /* duplex did not change */
	}
	...
	if (ok_to_print)
		printk(KERN_INFO "%s: link up, %sMbps, %s-duplex, lpa 0x%04X\n",
		       ...
		       lpa);
#if defined(CONFIG_EVTPROBE2)
	send_netlink_msg(SYSM_E1, 1, GFP_ATOMIC); /* E1 = 1, Ethernet link is UP event. */
#endif
