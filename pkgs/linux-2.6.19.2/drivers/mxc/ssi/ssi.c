...
/*!
 * This function dump the register content.
 *
 * @param        module        the module number
 * @param        length        the word length
 */
void ssi_dump_reg(ssi_mod module)
{
	unsigned int result;

	printk("%s - SSI config\n",__FUNCTION__);
	result = getreg_value(MXC_SSISCR, module);
	printk("MXC_SSISCR   (0x10) = 0x%x\n",result);
	result = getreg_value(MXC_SSISISR, module);
	printk("MXC_SSISISR  (0x14) = 0x%x\n",result);
	result = getreg_value(MXC_SSISIER, module);
	printk("MXC_SSISIER  (0x18) = 0x%x\n",result);
	result = getreg_value(MXC_SSISTCR, module);
	printk("MXC_SSISTCR  (0x1C) = 0x%x\n",result);
	result = getreg_value(MXC_SSISRCR, module);
	printk("MXC_SSISRCR  (0x20) = 0x%x\n",result);
	result = getreg_value(MXC_SSISTCCR, module);
	printk("MXC_SSISTCCR (0x24) = 0x%x\n",result);
	result = getreg_value(MXC_SSISRCCR, module);
	printk("MXC_SSISRCCR (0x28) = 0x%x\n",result);
	result = getreg_value(MXC_SSISFCSR, module);
	printk("MXC_SSISFCSR (0x2c) = 0x%x\n",result);
	result = getreg_value(MXC_SSISTR, module);
	printk("MXC_SSISTR   (0x30) = 0x%x\n",result);
	result = getreg_value(MXC_SSISOR, module);
	printk("MXC_SSISOR   (0x34) = 0x%x\n",result);
	result = getreg_value(MXC_SSISACNT, module);
	printk("MXC_SSISACNT (0x38) = 0x%x\n",result);
	result = getreg_value(MXC_SSISACADD, module);
	printk("MXC_SSISACADD (0x3c) = 0x%x\n",result);
	result = getreg_value(MXC_SSISACDAT, module);
	printk("MXC_SSISACDAT (0x40) = 0x%x\n",result);
	result = getreg_value(MXC_SSISATAG, module);
	printk("MXC_SSISATAG  (0x44) = 0x%x\n",result);
	result = getreg_value(MXC_SSISTMSK, module);
	printk("MXC_SSISTMSK  (0x48) = 0x%x\n",result);
	result = getreg_value(MXC_SSISRMSK, module);
	printk("MXC_SSISRMSK  (0x4C) = 0x%x\n",result);
}
