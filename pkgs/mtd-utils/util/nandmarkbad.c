/*
 *  This is a tool that marks a block as bad.
 *
 *  Copyright (C) 2006 - 2010 Sagemcom All rights reserved
 *
 *  File name: nandmarkbad.c
...
{
	printf("Usage: nandmarkbad [OPTION] MTD_DEVICE\n"
	       "Mark a block has bad. Return failure if system call has failed.\n"
	       "\n"
