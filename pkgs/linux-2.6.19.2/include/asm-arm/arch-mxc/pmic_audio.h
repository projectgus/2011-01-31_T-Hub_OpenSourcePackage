 ...
 */
typedef enum {
	USE_1_TIMESLOT,		/*!< Configure for 1 timeslot. */
...
/*!
 * IOCTL that gets headset state
 */
#define SNDRV_MXC_PCM_IOCTL_GET_HEADSET_STATE 12 /* Other ioctls are 
					in include/sound/pcm.h*/
/*@}*/
...
/*!
 * @brief Detect the state of the headset (plugged or unplugged)
 *
