...
#define SPI_DECT_DEVICE_NAME		"spi_dect"
#define SPI_DECT_CLOCK_FREQ		250000
#define SPI_DECT_CHIP_SELECT		1
#define SPI_DECT_BITS_PER_WORD		16
#define SPI_DECT_PADDING		0x35
#define SPI_DECT_MSG_LENGTH		32 /*! in bytes */
#define SPI_DECT_IRQ			IOMUX_TO_IRQ(MX31_PIN_TXD2)
#define SPI_DECT_MODE			SPI_MODE_3

struct spi_bus_info {
	int spi_loopback; /*! If non zero, loopback mode on spi 1 is on */
};
#endif
