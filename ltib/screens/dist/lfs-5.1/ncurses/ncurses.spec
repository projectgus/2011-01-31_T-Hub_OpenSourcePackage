...
$STRIP ${RPM_BUILD_ROOT}/%{pfx}/usr/lib/libform.so.5.3
$STRIP ${RPM_BUILD_ROOT}/%{pfx}/usr/lib/libmenu.so.5.3
$STRIP ${RPM_BUILD_ROOT}/%{pfx}/usr/lib/libncurses.so.5.3
$STRIP ${RPM_BUILD_ROOT}/%{pfx}/usr/lib/libpanel.so.5.3
