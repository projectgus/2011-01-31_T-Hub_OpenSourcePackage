...
#define FB_SYNC_RGB_565 	0x02000000
...
#define MXCFB_GET_BRIGHTNESS    _IOR('F', 0x24, __u8)
#define MXCFB_SET_BLANK         _IOW('F', 0x25, __u8)
#define MXCFB_GET_BLANK         _IOR('F', 0x26, __u8)
