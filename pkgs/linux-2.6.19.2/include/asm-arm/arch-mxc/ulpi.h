/*
 * Copyright 2006-2008 Sagem Communications.
 */
...
#ifndef __ASM_ARCH_MXC_ULPI_H__
#define __ASM_ARCH_MXC_ULPI_H__
...
#define MK_ULPI_ID(vid, pid)  ((unsigned int)( (((vid) & 0xFFFF) << 16 ) | ((pid) & 0xFFFF) ) )
