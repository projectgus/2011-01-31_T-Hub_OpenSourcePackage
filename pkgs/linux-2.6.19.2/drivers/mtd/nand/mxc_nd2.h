...
#define BAD_BLK_MARKER_SP_0     IO_ADDRESS(NFC_BASE_ADDR_AXI + 0x830) 
/* read column 0-1 byte, but only 1 is used for swapped main area data */
#define BAD_BLK_MARKER_SP_5     IO_ADDRESS(NFC_BASE_ADDR_AXI + 0x834) 
#define NAND_SPARE_BI_OFFSET           0x30
/*!
...
/* read column 0-1 byte, but only 1 is used for swapped main area data */
#define BAD_BLK_MARKER_SP_0     IO_ADDRESS(NFC_BASE_ADDR + 0x830) 
/* read column 0-1 byte, but only 1 is used for swapped main area data */
#define BAD_BLK_MARKER_SP_5     IO_ADDRESS(NFC_BASE_ADDR + 0x834) 
#define NAND_SPARE_BI_OFFSET           0x30
