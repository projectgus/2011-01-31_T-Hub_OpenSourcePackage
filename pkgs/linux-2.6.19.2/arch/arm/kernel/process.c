 ...
 *
 * Modified by Sagemcom under GPL license on 19/11/2007.
...
void arm_soft_machine_restart(char mode)
{
...
void (*arm_pm_soft_restart)(char str) = arm_soft_machine_restart;
EXPORT_SYMBOL_GPL(arm_pm_soft_restart);
...
void soft_machine_restart(char * __unused)
{
	arm_pm_soft_restart(reboot_mode);
}
