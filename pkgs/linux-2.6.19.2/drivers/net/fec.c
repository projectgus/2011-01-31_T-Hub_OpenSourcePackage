...
/* SAGEM includes to set ethphy voltage supply */
...
static void __inline__ fec_arch_init(void)
{
  ...
  volt.vmmc1 = VMMC1_2_6V;
  pmic_power_regulator_set_voltage(REGU_VMMC1,volt);
...
#ifdef CONFIG_MACH_MX27MEDIAPHONE
	//! CLD: Use GPIO PF12 for the same interrupt as EXPIO_INT_FEC
#warning CLD: FEC Interrupt missing.
#else
