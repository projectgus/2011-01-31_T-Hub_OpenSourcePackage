...
// SAGEM
#define V4L2_CID_TEST_PATTERN		(V4L2_CID_BASE+24)
...
#endif
//SAGEM
#define VIDIOC_S_REG	        _IOWR ('V', 76, struct register_set)
#define VIDIOC_ZOOMCAP          _IOWR ('V', 77, struct v4l2_zoomcap)
#define VIDIOC_G_ZOOM           _IOR  ('V', 78, struct v4l2_zoom)
#define VIDIOC_S_ZOOM           _IOWR ('V', 79, struct v4l2_zoom)
#define VIDIOC_G_PERF           _IOR  ('V', 80, struct v4l2_performance)
//end SAGEM

//SAGEM
#define VIDIOC_QUERYBUF_DISPLAY	_IOWR ('V',  81, struct v4l2_buffer)
#define VIDIOC_DQBUF_DISPLAY	_IOWR ('V',  82, struct v4l2_buffer)
//end SAGEM
