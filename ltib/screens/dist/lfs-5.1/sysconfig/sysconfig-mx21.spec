...
all_services="hostname mount-proc-sys udev filesystems syslog depmod modules network settime inetd portmap dropbear boa dhcpd dpmutils qtopia"
all_services_r="qtopia dpmutils dhcpd boa dropbear portmap inetd settime network modules depmod syslog filesystems hostname"

cfg_services="hostname mount-proc-sys udev filesystems $syslog depmod modules $network $settime $inetd $portmap $dropbear $boa $chcpd $dpmutils $qtopia"
cfg_services_r="$qtopia $dpmutils $dhcpd $boa $dropbear $portmap $inetd $settime $network modules depmod $syslog filesystems hostname"
