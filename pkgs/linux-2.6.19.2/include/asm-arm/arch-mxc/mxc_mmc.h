...
//#define STR_STP_CLK_IPG_CLK_GATE_DIS    (1<<15)   /*FSL said not to use this bit anymore*/
//#define STR_STP_CLK_IPG_PERCLK_GATE_DIS (1<<14)   /*FSL said not to use this bit anymore*/
