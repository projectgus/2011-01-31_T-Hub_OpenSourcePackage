...
// Also defined in include/asm-arm/arch-mxc/pmic_adc.h
// We put the same values here to avoid warnings and to match our touchscreen
// Original Values were 80 80
