...
Source          : gdb-6.0.tar.gz
Patch0          : gdb-6.2-sim-destdir.patch
Patch2          : gdb-6.0-tcsetpgrp.patch
Patch3          : gdb-6.0-sim-ppc-instructions.patch
Patch4          : gdb-6.0-nommu-3.patch
Patch5          : gdb-6.0-gcc-obstack.patch
...
then
    cd gdb/gdbserver
    sh ./configure --prefix=%{_prefix} --host=$CFGHOST --mandir=%{_mandir}
    make
    cd -
fi
