...
#define SET_ATLAS_REGISTER _IOWR('p', 0xbb, int)
#define GET_ATLAS_REGISTER _IOWR('p', 0xbc, int)
#define SET_MXC_REGISTER _IOWR('p', 0xbd, int)
#define GET_MXC_REGISTER _IOWR('p', 0xbe, int)
#else
#error PMIC2_ADC: MACH Unknown
...
// Modified by SAGEM in order to match our touchscreen: Original values 80 80
#define TS_X_MIN                30	/*! < Minimum X */
#define TS_Y_MIN                30	/*! < Minimum Y */
