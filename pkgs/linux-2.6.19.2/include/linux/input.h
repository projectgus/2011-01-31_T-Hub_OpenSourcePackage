 ...
 * Keys and buttons
 */
#define SAGEM_KEY_CALL		0
#define SAGEM_KEY_PHONEBOOK	1
#define SAGEM_KEY_CENTER	2
#define SAGEM_KEY_VOLUME	3
#define SAGEM_KEY_MUTE		4
#define SAGEM_KEY_MUSIC		5
#define SAGEM_KEY_START         6
#define SAGEM_KEY_UNUSED1       7
#define SAGEM_KEY_UNUSED2       8
