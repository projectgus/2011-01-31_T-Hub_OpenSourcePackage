...
clutter_backend_egl_dispose (GObject *gobject)
{
  ...
  eglDestroySurface (backend_egl->edpy, eglGetCurrentSurface(EGL_READ));
  eglDestroySurface (backend_egl->edpy, eglGetCurrentSurface(EGL_DRAW));
  ...
  eglMakeCurrent (backend_egl->edpy,
				  	   backend_egl->egl_surface, backend_egl->egl_surface,
