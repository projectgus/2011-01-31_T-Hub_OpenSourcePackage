 ...
 *			   Andreas Schwab
 *
 * Modified by Sagemcom under GPL license on 16/10/2007 
...
/* This function act as a placeholder for console blanking */
static int fbcon_blank_dummy(struct vc_data *vc, int blank, int mode_switch)
{
	return 0;
}
...
static const struct consw fb_con = {
	...
	.con_blank 		= fbcon_blank_dummy, /* SAGEM : fbcon_blank, */ 
